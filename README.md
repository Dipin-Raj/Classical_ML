...
📙 You can find the colab notebook for Task 01 in the [`Task_01_Notebook/`](https://colab.research.google.com/drive/1kMER8lM3ONT3aE27Cfl1lJ2C-AdkLeZ8?usp=sharing). 
📙 You can find the colab notebook for Task 02 in the [`Task_02_Notebook/`](https://colab.research.google.com/drive/1tRJKkBzhBNWSk7to4rs_u87lmRJKVSdk?usp=sharing).  
